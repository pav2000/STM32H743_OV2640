...
void ILI9341_render128x128(uint16_t *frameBuffer,int16_t x,int16_t y,int16_t w,int16_t h, bool frame)
{
	ILI9341_SetAddress(1, 2, 128, 128);
...
//	HAL_SPI_Transmit_DMA(HSPI_INSTANCE, (uint8_t*)frameBuffer, w*h*2);
	...
	if(frame){ //нарисовать рамку
        	ILI9341_DrawHLine(0, 96, 96, PINK);
	        ILI9341_DrawVLine(96, 0, 96, PINK);
	       }
}
