...
#define AI_NETWORK_MODEL_SIGNATURE     "2912e8f64e060a6dbec4d3f581bc8f0f"
...
#define AI_TOOLS_DATE_TIME   "Thu Apr  6 15:11:13 2023"
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    ...
    843400, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 153664, 1, 1),
    153664, NULL, NULL),
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    input_0_output_array.data = AI_PTR(g_network_activations_map[0] + 8160);
    input_0_output_array.data_start = AI_PTR(g_network_activations_map[0] + 8160);
    
    conv1_conv2d_output_array.data = AI_PTR(g_network_activations_map[0] + 6208);
    conv1_conv2d_output_array.data_start = AI_PTR(g_network_activations_map[0] + 6208);
    
    conv_dw_1_conv2d_output_array.data = AI_PTR(g_network_activations_map[0] + 79936);
    conv_dw_1_conv2d_output_array.data_start = AI_PTR(g_network_activations_map[0] + 79936);
    
    conv_pw_1_conv2d_output_array.data = AI_PTR(g_network_activations_map[0] + 1600);
    conv_pw_1_conv2d_output_array.data_start = AI_PTR(g_network_activations_map[0] + 1600);
    ...
    conv_pw_2_conv2d_output_array.data = AI_PTR(g_network_activations_map[0] + 79936);
    conv_pw_2_conv2d_output_array.data_start = AI_PTR(g_network_activations_map[0] + 79936);
    ...
    conv_pw_3_conv2d_output_array.data = AI_PTR(g_network_activations_map[0] + 73728);
    conv_pw_3_conv2d_output_array.data_start = AI_PTR(g_network_activations_map[0] + 73728);
    ...
    conv_pw_4_conv2d_output_array.data = AI_PTR(g_network_activations_map[0] + 18432);
    conv_pw_4_conv2d_output_array.data_start = AI_PTR(g_network_activations_map[0] + 18432);
    
    conv_dw_5_conv2d_output_array.data = AI_PTR(g_network_activations_map[0] + 55296);
    conv_dw_5_conv2d_output_array.data_start = AI_PTR(g_network_activations_map[0] + 55296);
    ...
    conv_dw_6_conv2d_output_array.data = AI_PTR(g_network_activations_map[0] + 36864);
    conv_dw_6_conv2d_output_array.data_start = AI_PTR(g_network_activations_map[0] + 36864);
    ...
    conv_dw_7_conv2d_output_array.data = AI_PTR(g_network_activations_map[0] + 18432);
    conv_dw_7_conv2d_output_array.data_start = AI_PTR(g_network_activations_map[0] + 18432);
    ...
    conv_dw_8_conv2d_output_array.data = AI_PTR(g_network_activations_map[0] + 18432);
    conv_dw_8_conv2d_output_array.data_start = AI_PTR(g_network_activations_map[0] + 18432);
    ...
    conv_dw_9_conv2d_output_array.data = AI_PTR(g_network_activations_map[0] + 18432);
    conv_dw_9_conv2d_output_array.data_start = AI_PTR(g_network_activations_map[0] + 18432);
    ...
    conv_dw_10_conv2d_output_array.data = AI_PTR(g_network_activations_map[0] + 18432);
    conv_dw_10_conv2d_output_array.data_start = AI_PTR(g_network_activations_map[0] + 18432);
    ...
    conv_dw_11_conv2d_output_array.data = AI_PTR(g_network_activations_map[0] + 18432);
    conv_dw_11_conv2d_output_array.data_start = AI_PTR(g_network_activations_map[0] + 18432);
    ...
    conv_dw_12_conv2d_output_array.data = AI_PTR(g_network_activations_map[0] + 18432);
    conv_dw_12_conv2d_output_array.data_start = AI_PTR(g_network_activations_map[0] + 18432);
    ...
    conv_dw_13_conv2d_output_array.data = AI_PTR(g_network_activations_map[0] + 9216);
    conv_dw_13_conv2d_output_array.data_start = AI_PTR(g_network_activations_map[0] + 9216);
    ...
    global_average_pooling2d_output_array.data = AI_PTR(g_network_activations_map[0] + 9216);
    global_average_pooling2d_output_array.data_start = AI_PTR(g_network_activations_map[0] + 9216);
