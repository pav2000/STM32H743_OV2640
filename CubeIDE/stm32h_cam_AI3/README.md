...
Нейросеть имеет на входе картинку 32х32х3, где первые два числа ширина и высота обрабатываемого изображения,
...
Результат распознавания получился не очень, особенно животных. Включение усреднения улучшает но не намного результаты работы.
